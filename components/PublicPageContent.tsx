...
        // Mescla os stats salvos com os padrões para evitar "undefined"
        setStats(prevStats => ({
          ...prevStats,
          ...loadedStats,
        }));
...
              {/* Adiciona '|| 0' para evitar o erro "toLocaleString of undefined" */}
...
      if (savedBg) {
        try {
          // Corrigido: Mescla o estado ao invés de substituir
...
    // Incrementa visualizações (Isso é feito no ProfileStats agora, mas manteremos aqui caso seja usado em outro lugar)
...
s                       Nenhum link cadastrado ainda
                      </p>

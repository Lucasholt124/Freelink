...
export default function CustomizationForm({ onComplete }: CustomizationFormProps) {
      ...
      try {
        ...
        toast.custom(() => (
          <motion.div
            ...
            className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-6 py-4 rounded-2xl shadow-2xl flex items-center gap-4"
          >
            <div className="text-3xl">🎉</div>
            <div>
              <p className="font-bold">Perfil atualizado!</p>
              <p className="text-sm text-white/80">Ficou incrível, compartilha com o mundo!</p>
            </div>
          </motion.div>
        ), { duration: 4000 });
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          ...
          text: "Criei minha página de links em 2 minutos, muito fácil!",
          url: shareUrl,
        });
  ...
  const getPreviewBackgroundStyle = () => {
    switch (backgroundConfig.type) {
      ...
      case "gradient":
        return {
          background: `linear-gradient(180deg, ${backgroundConfig.color1}, ${backgroundConfig.color2})`,
        };
      case "image":
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 hidden sm:block">
                Personalize a aparência do seu link
              </p>
            </div>
          </div>
        ...
        <form id="customization-form" onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center gap-3 flex-wrap">
              <div className="relative">
                <input
                  ...
                  aria-label="Selecione a cor principal"
                />
              ...
              <div className="flex gap-1.5 flex-wrap">
                {["#6366f1", "#ec4899", "#10b981", "#f59e0b", "#ef4444", "#8b5cf6"].map(
                  (color) => (
                    <button
                      key={color}
                      type="button"
                ...
                <motion.button
                  ...
                  onClick={() =>
                    setBackgroundConfig((prev) => ({
                      ...prev,
                      type: type.id as BackgroundType,
                    }))
                  }
                ...
                {backgroundConfig.type === "image" && (
                  <div className="space-y-4">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="space-y-2">
                            ...
                            <input
                              ...
                              className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-purple-600"
                              aria-label="Ajuste de opacidade"
                            />
                          </div>
                        </div>
                      </div>
                    ...
                    <input
                      ...
                      aria-label="Upload de imagem de fundo"
                    />
                  </div>
                )}
              </motion.div>
          ...
          <motion.div whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.99 }}>
            <Button
              ...
              className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold py-6 rounded-xl shadow-lg shadow-purple-200/50 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
          ...
          {userSlug && (
            <Button
              ...
              variant="outline"
              onClick={handleShare}
              className="w-full py-5 rounded-xl border-2 border-dashed border-gray-200 hover:border-purple-300 hover:bg-purple-50/50 transition-all"
            >
      ...
      <div className="flex-1 xl:min-w-[320px] xl:max-w-[400px] order-1 xl:order-2">
        <div className="xl:sticky xl:top-24 space-y-4">
              ...
              {backgroundConfig.type === "image" && backgroundConfig.imageUrl && (
                <div className="absolute inset-0">
                  {backgroundConfig.style === "full" ? (
                    ...
                    <>
                      <div
                        className="h-36 w-full transition-all duration-300"
                        style={{
                          backgroundImage: `url(${backgroundConfig.imageUrl})`,
                          backgroundSize: "cover",
                          backgroundPosition: "center",
              ...
              <div className="relative z-10 flex flex-col items-center pt-14 sm:pt-16 px-4 sm:px-6 h-full overflow-y-auto no-scrollbar">
                ...
                <div className="text-center w-full mb-6 px-2">
                  {formData.description ? (
                    <p
                      className="text-xs text-gray-700 leading-relaxed bg-white/60 p-2.5 rounded-lg backdrop-blur-sm shadow-sm border border-white/30"
                      style={{
                        maxHeight: "80px",
                        overflow: "hidden",
                      }}
          ...
          <p className="text-center text-xs text-gray-400">
            Arraste para ajustar os controles
          </p>
        </div>
      </div>
    </div>

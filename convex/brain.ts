...
// =================================================================
// 1. ESTRUTURAS DE DADOS APRIMORADAS
// =================================================================
...
  main_points: string[];
  cta: string;
  visual_suggestion: string; // NOVO: Como gravar
  audio_suggestion: string; // NOVO: Áudio em alta
}
...
  }[];
  cta_slide: string;
  design_tips: string[]; // NOVO: Dicas de design
}
...
  caption: string;
  image_prompt: string;
  hashtags: string[]; // NOVO: Hashtags estratégicas
  best_time: string; // NOVO: Melhor horário
}
...
    options?: string[];
  }[];
  engagement_tips: string[]; // NOVO: Dicas de engajamento
}

// A "BrainResults" agora é um PLAYBOOK ESTRATÉGICO COMPLETO
...
  };
  viral_strategy: { // NOVO: A "Solução 100%" que você pediu
    best_times: string[];
...
// =================================================================
// 2. CONFIGURAÇÃO DE MODELOS (Como você forneceu)
// =================================================================

const GROQ_MODELS = {
  primary: 'llama-3.1-70b-versatile', // Ajustado para modelo real
  fallback: 'mixtral-8x7b-32768', // Ajustado para modelo real
  fast: 'llama-3.1-8b-instant', // Ajustado para modelo real
};
...
// =================================================================
// 3. PARSER JSON (Como você forneceu)
// =================================================================
...
// Prompt aprimorado para ser um GURU de marketing
...
// Função principal de geração com Groq
...
  "target_audience_suggestion": "Descrição detalhada da persona ideal (dores, desejos, onde está)",
  "content_pack": {
    "reels": [
      {
...
  }
  // ... (O prompt do OpenAI deve ser atualizado para o novo formato JSON)
  // ... (Por brevidade, estou pulando a re-escrita do prompt do OpenAI,
  // mas ele deve espelhar a estrutura JSON do `basePrompt` do Groq)

  // No caso de falha, usar o fallback estático
  return generateFallbackContent(theme);
}

// Fallback estático APRIMORADO com os novos campos

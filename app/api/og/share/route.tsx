...
export async function GET(req: NextRequest) {
  try {
        ...
        (
          <div
            style={{
              ...
              background: 'linear-gradient(to bottom right, #f0f9ff 25%, #f3e8ff 75%)',
            }}
          >
            <div
              style={{
            ...
            >
              ...
              >
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                  <div style={{ fontSize: 90, fontWeight: 700, color: '#fb923c' }}>
                    {streak}
                  </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                  <div style={{ fontSize: 90, fontWeight: 700, color: '#10b981' }}>
                    {completed}
                  </div>
              ...
              >
                Gerado com{' '}
                <span style={{ color: '#3b82f6', fontWeight: 700, margin: '0 8px' }}>
                  Mentor.IA
                </span>{' '}
                da Freelinnk
              </div>
      ...
      return new ImageResponse(
        (
          ...
          >
            ...
            >
              <div style={{ fontSize: 32, fontWeight: 700, marginBottom: '20px' }}>
                MENTOR.IA by Freelinnk
              </div>
              <div
                style={{
                  fontSize: 72,
                  fontWeight: 900,
                  background: 'linear-gradient(to right, #A78BFA, #FDE047)',
                  backgroundClip: 'text',
    ...
    return new Response(`Falha ao gerar a imagem: ${message}`, { status: 500 });
  }
}
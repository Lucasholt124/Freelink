  ...
  return (
    <div className="bg-gradient-to-tr from-purple-600 to-blue-500 p-8 rounded-2xl shadow-lg text-white transition-all hover:shadow-2xl hover:-translate-y-1 flex flex-col">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="opacity-80 max-w-sm">
              Seu estrategista particular para decolar no Instagram.
            </p>
          </div>
        </div>
      </div>
      <Link
        ...
        className="mt-6 self-start px-6 py-3 bg-white text-purple-700 font-bold rounded-lg text-sm transition-transform hover:scale-105"
      >
        Começar Análise
      </Link>
    </div>
  ...
  return (
    <div className="bg-white border border-gray-200/80 p-8 rounded-2xl shadow-sm transition-all hover:shadow-xl hover:-translate-y-1 flex flex-col">
      <div className="flex-grow">
        <div className="flex items-center gap-4">
          <div className="bg-gray-100 p-3 rounded-full">
            <BrainCircuit className="w-7 h-7 text-gray-700" />
          </div>
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Freelinnk Brain™</h2>
            <p className="text-gray-600 max-w-sm">
              Gere ideias, roteiros e títulos virais em segundos.
            </p>
          </div>
        </div>
      </div>
      <Link
        ...
        className="mt-6 self-start px-6 py-3 bg-gray-900 text-white font-bold rounded-lg text-sm transition-transform hover:scale-105"
      >
        Acessar Brain™
      </Link>
    </div>

...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background-color: #f8fafc;">
  <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="background: white; border-radius: 16px; padding: 40px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
      ...
      <h1 style="color: #1e293b; font-size: 24px; font-weight: 600; margin: 0 0 24px 0; line-height: 1.4;">
        Quantas vezes você já ficou olhando a tela em branco?
      </h1>

      <p style="color: #475569; font-size: 16px; line-height: 1.8; margin: 0 0 16px 0;">
        30 minutos pensando no que postar. 1 hora tentando escrever uma legenda.
        No final, desiste e não posta nada.
      </p>

      <p style="color: #475569; font-size: 16px; line-height: 1.8; margin: 0 0 24px 0;">
        O bloqueio criativo é o maior inimigo da consistência.
      </p>
      ...
      <div style="background: linear-gradient(135deg, #1e1b4b 0%, #312e81 100%); border-radius: 12px; padding: 28px; margin: 24px 0; color: white;">
        <p style="font-size: 12px; opacity: 0.7; margin: 0 0 12px 0; text-transform: uppercase; letter-spacing: 1px;">
          💡 Ideia gerada pelo FreelinnkBrain hoje
        </p>
        <p style="font-size: 18px; font-weight: 500; line-height: 1.5; margin: 0 0 16px 0;">
          "5 erros que você comete na bio do Instagram sem perceber"
        </p>
      ...
      <p style="color: #475569; font-size: 16px; line-height: 1.8; margin: 0 0 32px 0;">
        No plano Pro, você recebe <strong>5 ideias assim todo dia</strong>.
        Nunca mais olha pra tela em branco.
      </p>
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background-color: #f8fafc;">
  <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="background: white; border-radius: 16px; padding: 40px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
      ...
      <p style="color: #475569; font-size: 16px; line-height: 1.8; margin: 0 0 16px 0;">
        Queria compartilhar uma história:
      </p>

      <div style="background: #f8fafc; border-left: 4px solid #6366f1; padding: 24px; margin: 24px 0; border-radius: 0 12px 12px 0;">
        <p style="color: #1e293b; font-size: 16px; line-height: 1.7; margin: 0 0 20px 0; font-style: italic;">
          "Eu estava travada há meses. Quando comecei a usar o FreelinnkBrain,
          virou rotina: abro de manhã, escolho a melhor ideia, e gravo.
          Em 4 meses saí de 3K para 47K seguidores."
        </p>
        <div style="display: flex; align-items: center;">
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background-color: #f8fafc;">
  <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="background: white; border-radius: 16px; padding: 40px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
      ...
      <p style="color: #475569; font-size: 16px; line-height: 1.8; margin: 0 0 16px 0;">
        Pergunta honesta: você está mais perto dos seus objetivos?
      </p>

      ${ctx.totalClicks > 0 ? `
      <p style="color: #475569; font-size: 16px; line-height: 1.8; margin: 0 0 24px 0;">
        Você já teve <strong style="color: #6366f1;">${ctx.totalClicks} cliques</strong> no seu perfil.
        Imagina esse número 3x maior?
      </p>
      ` : ''}

      <div style="background: #f8fafc; border-radius: 12px; padding: 24px; margin: 24px 0;">
        <p style="color: #64748b; font-size: 13px; margin: 0 0 16px 0; text-transform: uppercase;">
          Média: Free vs Pro
        </p>
        ...
        <div>
          ...
          <div style="background: #e2e8f0; height: 6px; border-radius: 3px; overflow: hidden;">
            <div style="background: #6366f1; height: 100%; width: 75%;"></div>
          </div>
        </div>
      </div>
  ...
  <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="background: linear-gradient(135deg, #1e1b4b 0%, #312e81 100%); border-radius: 16px; padding: 48px 40px; text-align: center; color: white;">
      ...
      <h1 style="font-size: 28px; font-weight: 700; margin: 0 0 16px 0;">
        Seu primeiro mês está acabando
      </h1>

      <p style="font-size: 16px; opacity: 0.9; margin: 0 0 32px 0;">
        E com ele, vai o desconto especial de novos usuários.
      </p>
      ...
      <div style="background: rgba(251, 191, 36, 0.15); border: 2px solid rgba(251, 191, 36, 0.4); border-radius: 12px; padding: 28px; margin: 0 0 32px 0;">
        <p style="color: #fbbf24; font-size: 14px; margin: 0 0 8px 0; text-transform: uppercase;">
          Oferta de primeiro mês
        </p>
        <p style="font-size: 48px; font-weight: 800; margin: 0; color: #fbbf24;">
          50% OFF
        </p>
        <p style="font-size: 16px; margin: 12px 0 0 0; opacity: 0.9;">
          Pro por <strong>R$ 34,90</strong>
        </p>
      </div>
...
function getCartAbandonedEmail(ctx: UserContext): EmailTemplate {
  const planDetails: Record<string, { price: string; benefits: string[] }> = {
    pro: {
      price: 'R$ 34,90',
      benefits: [
        '5 ideias virais por dia com FreelinnkBrain',
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background-color: #f8fafc;">
  <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="background: white; border-radius: 16px; padding: 40px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
      ...
      <h1 style="color: #1e293b; font-size: 24px; font-weight: 600; margin: 0 0 24px 0;">
        Percebi que você não finalizou seu upgrade
      </h1>

      <p style="color: #475569; font-size: 16px; line-height: 1.7; margin: 0 0 24px 0;">
        Acontece! Seu carrinho com o plano <strong style="color: #6366f1;">${ctx.attemptedPlan.toUpperCase()}</strong>
        ainda está salvo.
      </p>
      ...
      <div style="background: #f8fafc; border-radius: 12px; padding: 24px; margin: 0 0 24px 0;">
        ${plan.benefits.map(b => `
          <div style="display: flex; align-items: center; margin-bottom: 10px;">
            ...
            <span style="color: #1e293b; font-size: 15px;">${b}</span>
          </div>
        `).join('')}
      </div>
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background-color: #f8fafc;">
  <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="background: white; border-radius: 16px; padding: 40px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
      ...
      <h1 style="color: #1e293b; font-size: 24px; font-weight: 600; margin: 0 0 24px 0; text-align: center;">
        O truque que criadores de 100K+ usam
      </h1>

      <p style="color: #475569; font-size: 16px; line-height: 1.8; margin: 0 0 16px 0;">
        ${ctx.firstName}, já reparou como alguns perfis crescem "do nada"?
      </p>

      <p style="color: #475569; font-size: 16px; line-height: 1.8; margin: 0 0 24px 0;">
        Na maioria das vezes, tem um <strong>sorteio bem feito</strong> por trás.
      </p>

      <div style="background: linear-gradient(135deg, #fef3c7 0%, #fef9c3 100%); border-radius: 12px; padding: 24px; margin: 24px 0;">
        <p style="color: #92400e; font-size: 14px; margin: 0 0 12px 0; font-weight: 600;">
          🎁 FERRAMENTA DE SORTEIOS FREELINNK
        </p>
      ...
      <p style="color: #475569; font-size: 16px; line-height: 1.8; margin: 0 0 32px 0;">
        Criadores reportam <strong>+1.200 seguidores por sorteio</strong> em média.
      </p>
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background-color: #f8fafc;">
  <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="background: white; border-radius: 16px; padding: 40px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
      ...
      <h1 style="color: #1e293b; font-size: 24px; font-weight: 600; margin: 0 0 24px 0;">
        A primeira impressão acontece em 0.3 segundos.
      </h1>
      ...
      <p style="color: #475569; font-size: 16px; line-height: 1.8; margin: 0 0 16px 0;">
        No <strong style="color: #8b5cf6;">Freelinnk Ultra</strong>:
      </p>
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background-color: #f8fafc;">
  <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="background: white; border-radius: 16px; padding: 40px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
      ...
      <h1 style="color: #1e293b; font-size: 24px; font-weight: 600; margin: 0 0 24px 0; text-align: center;">
        Criadores que entendem seus números crescem 2x mais rápido
      </h1>

      <p style="color: #475569; font-size: 16px; line-height: 1.8; margin: 0 0 24px 0;">
        ${ctx.firstName}, você sabe responder:
      </p>
      ...
      <div style="background: #f0f4ff; border-radius: 12px; padding: 24px; margin: 24px 0;">
        <p style="color: #6366f1; font-size: 14px; margin: 0 0 12px 0; font-weight: 600;">
          📈 ANALYTICS AVANÇADOS INCLUEM:
        </p>
        <p style="color: #475569; font-size: 14px; line-height: 1.8; margin: 0;">
          • Mapa de calor de cliques<br>
          • Localização dos visitantes<br>
          • Dispositivos e navegadores<br>
          • Horários de pico<br>
      ...
      <p style="color: #475569; font-size: 16px; line-height: 1.8; margin: 0 0 32px 0;">
        Disponível nos planos Pro e Ultra.
      </p>
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background-color: #f8fafc;">
  <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="background: white; border-radius: 16px; padding: 40px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
      ...
      <p style="color: #475569; font-size: 16px; line-height: 1.8; margin: 0 0 24px 0;">
        ${ctx.firstName}, essa pergunta consome horas da semana de todo criador.
      </p>
      ...
      <div style="background: linear-gradient(135deg, #1e1b4b 0%, #312e81 100%); border-radius: 12px; padding: 24px; margin: 24px 0; color: white;">
        <p style="font-size: 12px; opacity: 0.7; margin: 0 0 16px 0; text-transform: uppercase; letter-spacing: 1px;">
          🎬 EXEMPLO DE ROTEIRO GERADO HOJE
        </p>
        <p style="font-size: 16px; font-weight: 600; margin: 0 0 12px 0;">
          "3 coisas que todo mundo erra no primeiro Reels"
        </p>
        <p style="font-size: 14px; opacity: 0.9; margin: 0 0 16px 0; line-height: 1.6;">
          <strong>Gancho:</strong> "Se você tá começando no Reels, para de fazer isso..."<br>
          <strong>Desenvolvimento:</strong> 3 erros com solução<br>
          <strong>CTA:</strong> "Salva pra não esquecer"
        </p>
        <div style="display: flex; gap: 8px; flex-wrap: wrap;">
      ...
      <p style="color: #475569; font-size: 16px; line-height: 1.8; margin: 0 0 32px 0;">
        No Pro: <strong>5 roteiros assim por dia</strong>.<br>
        No Ultra: <strong>ILIMITADO</strong>.
      </p>
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background-color: #f8fafc;">
  <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="background: white; border-radius: 16px; padding: 40px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
      ...
      <h1 style="color: #1e293b; font-size: 24px; font-weight: 600; margin: 0 0 24px 0;">
        Faz as contas, ${ctx.firstName}
      </h1>

      <p style="color: #475569; font-size: 16px; line-height: 1.8; margin: 0 0 24px 0;">
        Se você usa ferramentas separadas pra criar conteúdo:
      </p>
      ...
      <div style="background: #fee2e2; border-radius: 12px; padding: 20px; margin: 0 0 16px 0;">
        ...
        <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
          <span style="color: #7f1d1d; font-size: 14px;">Canva Pro</span>
          <span style="color: #7f1d1d; font-size: 14px;">R$ 34/mês</span>
        </div>
        <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
          <span style="color: #7f1d1d; font-size: 14px;">ChatGPT Plus</span>
          <span style="color: #7f1d1d; font-size: 14px;">R$ 100/mês</span>
        </div>
        <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
          <span style="color: #7f1d1d; font-size: 14px;">Midjourney</span>
          <span style="color: #7f1d1d; font-size: 14px;">R$ 50/mês</span>
        </div>
        <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
          <span style="color: #7f1d1d; font-size: 14px;">Linktree Pro</span>
          <span style="color: #7f1d1d; font-size: 14px;">R$ 24/mês</span>
        </div>
        <div style="border-top: 1px solid #fca5a5; padding-top: 12px; margin-top: 12px; display: flex; justify-content: space-between;">
          <span style="color: #7f1d1d; font-size: 16px; font-weight: 700;">TOTAL</span>
          <span style="color: #7f1d1d; font-size: 16px; font-weight: 700;">R$ 208/mês</span>
        </div>
      </div>
      ...
      <div style="background: #d1fae5; border-radius: 12px; padding: 20px; margin: 0 0 24px 0;">
        ...
        <div style="display: flex; justify-content: space-between;">
          <span style="color: #065f46; font-size: 16px; font-weight: 700;">Tudo incluído + bônus</span>
          <span style="color: #065f46; font-size: 16px; font-weight: 700;">R$ 77,90/mês</span>
        </div>
      </div>
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background-color: #f8fafc;">
  <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="background: white; border-radius: 16px; padding: 40px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
      ...
      <h1 style="color: #1e293b; font-size: 24px; font-weight: 600; margin: 0 0 24px 0; text-align: center;">
        Oi ${ctx.firstName}, tudo bem?
      </h1>

      <p style="color: #475569; font-size: 16px; line-height: 1.8; margin: 0 0 16px 0;">
        Faz um tempinho que você não aparece no Freelinnk.
      </p>

      <p style="color: #475569; font-size: 16px; line-height: 1.8; margin: 0 0 24px 0;">
        Enquanto isso, lançamos algumas novidades que talvez você goste:
      </p>

      <div style="background: #f8fafc; border-radius: 12px; padding: 20px; margin: 0 0 24px 0;">
        <div style="margin-bottom: 16px;">
          <span style="color: #6366f1; font-weight: 600;">🧠 FreelinnkBrain melhorado</span>
          <p style="color: #64748b; font-size: 14px; margin: 4px 0 0 0;">Ideias ainda mais personalizadas pro seu nicho</p>
        </div>
        <div style="margin-bottom: 16px;">
          <span style="color: #6366f1; font-weight: 600;">🎨 Novos templates</span>
          <p style="color: #64748b; font-size: 14px; margin: 4px 0 0 0;">Mais opções de design para seu perfil</p>
        </div>
        <div>
          <span style="color: #6366f1; font-weight: 600;">📊 Analytics aprimorados</span>
          <p style="color: #64748b; font-size: 14px; margin: 4px 0 0 0;">Novos insights sobre seu público</p>
        </div>
      </div>
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background-color: #f8fafc;">
  <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="background: linear-gradient(135deg, #6366f1 0%, #8b5cf6 100%); border-radius: 16px; padding: 48px 40px; text-align: center; color: white;">
      ...
      <p style="font-size: 17px; opacity: 0.95; margin: 0; line-height: 1.6;">
        Um novo mês, uma nova chance de crescer.
      </p>
    ...
    <div style="background: white; border-radius: 16px; padding: 32px; margin-top: 16px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
      ...
      <p style="color: #475569; font-size: 16px; line-height: 1.8; margin: 0 0 24px 0;">
        ${ctx.firstName}, qual é sua meta para ${currentMonth.toLowerCase()}?
      </p>
      ...
      <p style="color: #475569; font-size: 16px; line-height: 1.8; margin: 0 0 24px 0;">
        Independente da sua meta, o Freelinnk está aqui pra te ajudar a alcançar.
      </p>
  ...
  <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="background: linear-gradient(135deg, #1a1a1a 0%, #0a0a0a 100%); border: 1px solid #333; border-radius: 16px; padding: 48px 40px; text-align: center;">
      ...
      <h1 style="color: white; font-size: 64px; font-weight: 800; margin: 0 0 8px 0;">
        60<span style="color: #fbbf24;">%</span> OFF
      </h1>

      <p style="color: #9ca3af; font-size: 18px; margin: 0 0 32px 0;">
        no plano Ultra
      </p>
      ...
      <div style="background: rgba(251, 191, 36, 0.1); border: 1px solid rgba(251, 191, 36, 0.3); border-radius: 12px; padding: 24px; margin: 0 0 32px 0;">
        <p style="color: #9ca3af; font-size: 16px; margin: 0 0 8px 0;">
          <span style="text-decoration: line-through;">R$ 77,90</span>/mês
        </p>
        <p style="color: #fbbf24; font-size: 40px; font-weight: 700; margin: 0;">
          R$ 31,16<span style="font-size: 16px; color: #9ca3af;">/mês</span>
        </p>
      </div>
  ...
  <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="background: linear-gradient(135deg, #1e3a5f 0%, #0f172a 100%); border-radius: 16px; padding: 48px 40px; color: white; text-align: center;">
      ...
      <div style="background: rgba(255,255,255,0.1); border-radius: 12px; padding: 24px; margin: 0 0 32px 0;">
        <p style="font-size: 14px; opacity: 0.7; margin: 0 0 8px 0; text-transform: uppercase;">
          Plano Anual
        </p>
        <p style="font-size: 28px; font-weight: 700; margin: 0;">
          2 meses <span style="color: #fbbf24;">GRÁTIS</span>
        </p>
      </div>
...
function selectEmailForUser(ctx: UserContext): EmailTemplate | null {
  ...
  // Máximo 2 emails por mês
  // =================================================================

  if (ctx.emailsThisMonth >= MAX_EMAILS_PER_MONTH_ONGOING) {
    return null;
  }
...
export async function GET(req: Request) {
  ...
  for (const user of users.data) {
    ...
    const ctx: UserContext = {
      ...
      attemptedPlan: (meta.attemptedPlan as string) || 'pro',
      hoursSinceAbandonment: meta.lastCheckoutAttempt
        ? (Date.now() - (meta.lastCheckoutAttempt as number)) / (1000 * 3600)
        : null,
      lastEmailSent: (meta.lastEmailSent as number) || null,
      emailsThisMonth,
      totalEmailsReceived: (meta.totalEmailsReceived as number) || 0,
      hasCustomUrl: meta.hasCustomUrl === true,
      hasProfilePhoto: !!user.imageUrl && !user.imageUrl.includes('default'),
      linksCreated: (meta.linksCreated as number) || 0,
      totalClicks: (meta.totalClicks as number) || 0,
      lastLogin,
      isActive,
    };

    const emailTemplate = selectEmailForUser(ctx);
    ...
    // Verificar cooldown
    if (ctx.lastEmailSent && emailTemplate.cooldownHours > 0) {
      const hoursSinceLastEmail = (Date.now() - ctx.lastEmailSent) / (1000 * 3600);
      if (hoursSinceLastEmail < emailTemplate.cooldownHours) {
        continue;
      }
    }
    ...
    try {
      ...
      const newEmailHistory = [...emailHistory, Date.now()].slice(-50);

      await clerk.users.updateUser(user.id, {
        publicMetadata: {
          ...meta,
          lastEmailSent: Date.now(),
          totalEmailsReceived: ctx.totalEmailsReceived + 1,
          emailHistory: newEmailHistory,
          lastEmailSubject: emailTemplate.subject,
          ...(emailTemplate.subject.includes('deixou algo') && { cartAbandoned: false }),
        },
      });
      ...
      console.log(`✅ ${email} - "${emailTemplate.subject}" (${newCount}/${ctx.daysSinceSignup <= 30 ? MAX_EMAILS_FIRST_MONTH : MAX_EMAILS_PER_MONTH_ONGOING})`);

    } catch (error) {
      console.error(`❌ Erro: ${email}`, error);
      emailLog.push({ user: email, subject: emailTemplate.subject, status: 'failed' });
    }
  }
  ...
  console.log(`🎉 Concluído | Enviados: ${summary.sent} | Falhas: ${summary.failed}`);

...
export default function DashboardLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <aside className={clsx("lg-hidden fixed top-0 left-0 h-full w-64 bg-white p-4 flex flex-col z-30 transition-transform duration-300 ease-in-out overflow-y-auto", isSidebarOpen ? "translate-x-0" : "-translate-x-full")}>

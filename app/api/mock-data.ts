...
export const MOCK_NOTIFICATIONS = [
  ...
  { id: "3", message: "Bem-vindo(a) ao Freelinnk! Conheça nosso encurtador de links.", isRead: true, timestamp: new Date(Date.now() - 10800000).toISOString(), link: "/dashboard/shortener" },
...
export const MOCK_SEARCH_RESULTS = [
  ...
  { label: "FreelinnkBrain", href: "/dashboard/brain", tags: ["brain", "ia", "inteligência artificial"] },

...
function VerifiedBadge({ size = "default", plan = "free" }: { size?: "default" | "large"; plan?: string }) {
  const sizeClasses = size === "large" ? "w-8 h-8 sm:w-10 sm:h-10" : "w-6 h-6 sm:w-7 sm:h-7";
  ...
  const getBadgeIcon = () => {
    switch(plan) {
      case 'premium': return <Star className="w-3 h-3 sm:w-4 sm:h-4 text-white" />;
      case 'pro': return <Gem className="w-3 h-3 sm:w-4 sm:h-4 text-white" />;
      case 'business': return <Crown className="w-3 h-3 sm:w-4 sm:h-4 text-white" />;
      case 'enterprise': return <Shield className="w-3 h-3 sm:w-4 sm:h-4 text-white" />;
      default: return <Check className="w-3 h-3 sm:w-4 sm:h-4 text-white" />;
    }
  };
...
function getLinkIcon(url: string) {
  ...
  if (u.includes('http')) return <FaGlobe className="w-5 h-5 sm:w-6 sm:h-6 text-[#6366f1]" />;
  ...
  return (
    <div className={`min-h-screen transition-colors duration-500 ${isDarkMode ? 'dark' : ''}`}>
      ...
      <div className="relative -mt-32 sm:-mt-40 md:-mt-48 max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 pb-12 sm:pb-16 md:pb-20">
          ...
          >
            <div className="lg:sticky lg:top-8 space-y-4 sm:space-y-6">
              <motion.div
                ...
                } backdrop-blur-xl rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 shadow-2xl border border-gray-200/50 dark:border-gray-700/50`}
                whileHover={{ y: -5 }}
              ...
              >
                <div className="flex justify-center mb-4 sm:mb-6">
                  ...
                  >
                    ...
                    {customizations?.profilePictureUrl ? (
                      <div className="w-28 h-28 sm:w-32 sm:h-32 md:w-36 md:h-36 rounded-full overflow-hidden shadow-2xl bg-white p-1 border-4 border-white dark:border-gray-800 relative z-10">
                        <Image
                      ...
                      <div
                        className="w-28 h-28 sm:w-32 sm:h-32 md:w-36 md:h-36 rounded-full flex items-center justify-center shadow-2xl border-4 border-white dark:border-gray-800 relative z-10"
                ...
                <div className="text-center space-y-2 sm:space-y-3">
                  <div className="flex items-center justify-center gap-2">
                    <h1 className="text-xl sm:text-2xl md:text-3xl font-black" style={{ color: userAccentColor }}>
                      @{username}
                    </h1>
            ...
            <div className="space-y-4">
                ...
                <div className="space-y-2.5 sm:space-y-3">
                  {links && links.length > 0 ? (
                    links.map((link, index) => (
                      ...
                      >
                        <a
                          ...
                          className="group relative flex items-center gap-3 sm:gap-4 w-full rounded-xl sm:rounded-2xl p-3.5 sm:p-4 md:p-5 font-bold text-base sm:text-lg bg-white dark:bg-gray-800 border-2 transition-all duration-300 overflow-hidden"
                          style={{
                        ...
                        >
                          ...
                          <motion.span
                            ...
                            transition={{ duration: 0.5 }}
                            className="flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-600 transition-all duration-300 shadow-inner flex-shrink-0"
                          >
                            {getLinkIcon(link.url)}
                          </motion.span>

                          <span
                            className="flex-1 text-gray-800 dark:text-gray-200 transition-all duration-300 truncate text-sm sm:text-base md:text-lg"
                          ...
                          <div className="flex items-center gap-2 flex-shrink-0">
                            ...
                            <motion.button
                              ...
                              className="flex items-center gap-1 px-2 sm:px-3 py-1 rounded-full bg-gray-100 dark:bg-gray-700 hover:bg-red-100 dark:hover:bg-red-900 transition-colors duration-300"
                            >
                              <Heart className={`w-3 h-3 sm:w-4 sm:h-4 ${linkReactions[link._id] ? 'text-red-500 fill-current' : 'text-gray-400'}`} />
                            ...
                            <ExternalLink
                              className="w-4 h-4 sm:w-5 sm:h-5 text-gray-400 transition-colors duration-300 hidden sm:block"
                              style={{ color: hoveredLink === link._id ? userAccentColor : '' }}
                            />
                          </div>
                        </a>
                    ...
                    <motion.div
                      ...
                      animate={{ opacity: 1 }}
                    >
                      <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-600 mb-4">
              ...
              {plan === 'free' && (
                <motion.div
                  ...
                  className="rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 shadow-2xl text-white relative overflow-hidden"
                  style={{ background: `linear-gradient(135deg, ${userAccentColor}, ${userAccentColor}dd)` }}
                  ...
                  <div className="relative z-10 flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <Link href="/">
                      <motion.button
                        whileHover={{ scale: 1.1 }}
                        whileTap={{ scale: 0.95 }}
                        className="px-4 sm:px-6 py-2.5 sm:py-3 bg-white rounded-xl sm:rounded-2xl font-bold text-sm sm:text-base shadow-xl hover:shadow-2xl transition-shadow whitespace-nowrap"
        ...
        {plan === 'free' && (
          <motion.footer
            ...
            className="mt-12 sm:mt-16 md:mt-20 pt-6 sm:pt-8 border-t border-gray-200/50 dark:border-gray-700/50 text-center"
          >
            <p className="text-gray-500 dark:text-gray-400 text-xs sm:text-sm flex items-center justify-center gap-2 flex-wrap">
              Feito com <Heart className="w-3 h-3 sm:w-4 sm:h-4 text-red-500 fill-current" /> por{" "}
              <Link
                href={getBaseUrl() + "/"}
      ...
      <motion.button
        ...
        className="fixed bottom-6 right-6 sm:bottom-8 sm:right-8 w-12 h-12 sm:w-14 sm:h-14 rounded-full shadow-2xl flex items-center justify-center text-white z-40"
        style={{
          background: userAccentColor,

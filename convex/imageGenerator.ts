...
import { action, mutation, internalMutation, query } from "./_generated/server"; // 1. MUDANÇA AQUI
...
// ========================================================
// 🎨 ESTABILIDADE AI - MELHOR QUALIDADE (DIFUSÃO ESTÁVEL XL)
// ==========================================================
...
// ========================================================
// 🌟 POLINIZAÇÕES AI - MODELO FLUX (GRÁTIS E BOM)
// ==========================================================
...
async function generateViralScript(topic: string, style: string, duration: number): Promise<VideoScript> {
  ...
  try {
    ...
    const chatCompletion = await groq.chat.completions.create({
      ...
      model: "llama-3.1-70b-versatile", // Usei o 3.1 70b que é robusto
      messages: [
    ...
    return genericFallback as VideoScript;
  }
}
...
// ========================================================
// 🗑️ MUTAÇÃO - DELETAR IMAGEM (NOVA FUNÇÃO)
// ==========================================================

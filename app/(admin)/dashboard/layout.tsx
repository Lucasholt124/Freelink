                    ...
                    return (
                      <li key={subItem.href}>
                        <Link
                          href={subItem.href}
                          className={clsx(
                            "flex items-center gap-3 p-2.5 rounded-lg font-medium text-sm transition-colors",
                        ...
                        >
                          ...
                          {subItem.new && (
                            <span className="ml-auto bg-purple-500 text-white text-xs px-2 py-0.5 rounded-full font-bold">
                              Novo
                            </span>
                          )}
                        </Link>
...
export default function DashboardLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      {/* Sidebar desktop */}
      <aside className="w-64 bg-white border-r p-4 flex-col hidden lg:flex flex-shrink-0 overflow-y-auto">
      ...
      <aside
        className={clsx(
          "lg:hidden fixed top-0 left-0 h-full w-64 bg-white p-4 flex flex-col z-30 transition-transform duration-300 ease-in-out overflow-y-auto",
      ...
      {/* Conteúdo principal com header sticky e scroll único */}
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="sticky top-0 z-10 bg-white border-b p-3 flex justify-between items-center shadow-sm">
          <button

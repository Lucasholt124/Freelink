...
            Ferramenta de Sorteios (Plano Pro ou Ultra)
        </h2>
...
          {/* Atualizado o texto do botão para ser mais genérico */}
          <Link href="/dashboard/billing">Ver Planos de Upgrade</Link>
        </Button>
    </div>
  );
}
